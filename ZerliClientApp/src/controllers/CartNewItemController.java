...
public class CartNewItemController extends HBox{
	...
	public void init(Label totalCost, VBox Vbox ,Image image1 ,int id,String name,
					int quntity,int price,NewItem newItem) 
	{
   ...
   {	   
	   ...
	   totalCost.setText(String.valueOf((Integer)LoginController.windowControl.peekPipe("totalCost")-price*quntity));
...
//    	Vbox.getChildren().remove(hboxRoot);
//    	ClientApp.ProtocolHandler.Invoke(RequestType.DeleteItemFromNewItemList, id, null, true);
